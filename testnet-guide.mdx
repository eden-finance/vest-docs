...
<Note>
**cNGN Test Token Address**: `0x1234567890123456789012345678901234567890` (TBD - Update with actual testnet address)
</Note>
...
await window.ethereum.request({
  ...
  params: {
    type: 'ERC20',
    options: {
      address: '0x1234567890123456789012345678901234567890', // cNGN testnet address
      symbol: 'cNGN',
      decimals: 18,
